...
// 음성 설정 (toolkit/tts.mjs). 샘플 A 선택: 밝고 귀엽게
const VOICE = { VOICE_ENGINE: 'qwen', VOICE: 'Sohee', VOICE_INSTRUCT: '밝고 귀엽고 에너지 넘치는 톤, 살짝 웃으면서 말하듯이', VOICE_SPEED: 1.15 };
...
window.SCRIPT = { toSay, voice: VOICE, chapters: [
